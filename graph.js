...
const seoMetrics = {
  labels: ["May 2024", "June 2024", "July 2024", "August 2024"],
  datasets: [
    {
      label: "Sessions",
      data: [16414, 14482, 19192, 20972],
  ...
  datasets: [
    {
      ...
      data: [1.23, 1.33, 1.35, 1.32], // Decimal minutes data
      borderColor: "rgba(54, 162, 235, 1)",
      backgroundColor: "rgba(54, 162, 235, 0.2)",
      fill: true,
    },
